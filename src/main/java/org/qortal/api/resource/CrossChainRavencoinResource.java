...
public class CrossChainRavencoinResource {
	...
	public String getRavencoinWalletBalance(String key58) {
	...
	@ApiErrors({ApiError.INVALID_PRIVATE_KEY, ApiError.FOREIGN_BLOCKCHAIN_NETWORK_ISSUE})
	public List<SimpleTransaction> getRavencoinWalletTransactions(String key58) {
		Security.checkApiCallAllowed(request);
	...
	public String sendBitcoin(RavencoinSendRequest ravencoinSendRequest) {
		Security.checkApiCallAllowed(request);
