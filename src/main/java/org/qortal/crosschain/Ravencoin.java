...
import org.libdohj.params.RavencoinRegTestParams;
import org.libdohj.params.RavencoinTestNet3Params;
...
public class Ravencoin extends Bitcoiny {
	...
	public enum RavencoinNet {
		MAIN {
			...
			public Collection<Server> getServers() {
				return Arrays.asList(
						...
						new Server("ravennode-01.beep.pw", ConnectionType.SSL, 50002));
		...
		TEST3 {
			@Override
			public NetworkParameters getParams() {
				return RavencoinTestNet3Params.get();
			}
		...
		REGTEST {
			@Override
			public NetworkParameters getParams() {
				return null; // TODO: RavencoinRegTestParams.get();
			}
