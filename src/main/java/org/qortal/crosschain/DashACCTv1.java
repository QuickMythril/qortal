 ...
 * </ul>
 */
public class DashACCTv1 implements ACCT {

	private static final Logger LOGGER = LogManager.getLogger(DashACCTv1.class);

	public static final String NAME = DashACCTv1.class.getSimpleName();
	public static final byte[] CODE_BYTES_HASH = HashCode.fromString("0201").asBytes(); // SHA256 of AT code bytes
	...
	private static DashACCTv1 instance;

	private DashACCTv1() {
	}

	public static synchronized DashACCTv1 getInstance() {
		if (instance == null)
			instance = new DashACCTv1();
	...
	public static byte[] buildQortalAT(String creatorTradeAddress, byte[] dashPublicKeyHash, long qortAmount, long dashAmount, int tradeTimeout) {
		...
		assert Arrays.equals(Crypto.digest(codeBytes), DashACCTv1.CODE_BYTES_HASH)
