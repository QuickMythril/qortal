package org.qortal.test.crosschain.komodov3;
...
import org.qortal.crosschain.KomodoACCTv3;
...
public class KomodoACCTv3Tests extends Common {
	...
	public static final byte[] komodoPublicKeyHash = HashCode.fromString("bb00bb11bb22bb33bb44bb55bb66bb77bb88bb99").asBytes();
	public static final int tradeTimeout = 20; // blocks
	public static final long redeemAmount = 80_40200000L;
	public static final long fundingAmount = 123_45600000L;
	public static final long komodoAmount = 864200L; // 0.00864200 KMD
	...
	public void testCompile() {
		...
		byte[] creationBytes = KomodoACCTv3.buildQortalAT(tradeAccount.getAddress(), komodoPublicKeyHash, redeemAmount, komodoAmount, tradeTimeout);
	...
	public void testOfferCancel() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			byte[] messageData = KomodoACCTv3.getInstance().buildCancelMessage(deployer.getAddress());
			...
			CrossChainTradeData tradeData = KomodoACCTv3.getInstance().populateTradeData(repository, atData);
	...
	public void testTradingInfoProcessing() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			int refundTimeout = KomodoACCTv3.calcRefundTimeout(partnersOfferMessageTransactionTimestamp, lockTimeA);

			// Send trade info to AT
			byte[] messageData = KomodoACCTv3.buildTradeMessage(partner.getAddress(), komodoPublicKeyHash, hashOfSecretA, lockTimeA, refundTimeout);
			...
			// Check trade partner's komodo PKH was extracted correctly
			assertTrue(Arrays.equals(komodoPublicKeyHash, tradeData.partnerForeignPKH));
	...
	public void testCorrectSecretCorrectSender() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			messageData = KomodoACCTv3.buildRedeemMessage(secretA,  partner.getAddress());
	...
	public void testIncorrectSecretCorrectSender() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			messageData = KomodoACCTv3.buildRedeemMessage(wrongSecret, partner.getAddress());
			messageTransaction = sendMessage(repository, partner, messageData, atAddress);
	...
	public void testDescribeDeployed() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			for (ATData atData : executableAts) {
				...
				// Not one of ours?
				if (!Arrays.equals(codeHash, KomodoACCTv3.CODE_BYTES_HASH))
					continue;
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = KomodoACCTv3.buildQortalAT(tradeAddress, komodoPublicKeyHash, redeemAmount, komodoAmount, tradeTimeout);
		...
		Long fee = null;
		String name = "QORT-KMD cross-chain trade";
		String description = String.format("Qortal-Komodo cross-chain trade");
		String atType = "ACCT";
		String tags = "QORT-KMD ACCT";
