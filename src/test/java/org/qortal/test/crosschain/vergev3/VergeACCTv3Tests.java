package org.qortal.test.crosschain.vergev3;
...
import org.qortal.crosschain.VergeACCTv3;
...
public class VergeACCTv3Tests extends Common {
	...
	public static final byte[] vergePublicKeyHash = HashCode.fromString("bb00bb11bb22bb33bb44bb55bb66bb77bb88bb99").asBytes();
	public static final int tradeTimeout = 20; // blocks
	public static final long redeemAmount = 80_40200000L;
	public static final long fundingAmount = 123_45600000L;
	public static final long vergeAmount = 864200L; // 0.00864200 XVG
	...
	public void testCompile() {
		...
		byte[] creationBytes = VergeACCTv3.buildQortalAT(tradeAccount.getAddress(), vergePublicKeyHash, redeemAmount, vergeAmount, tradeTimeout);
	...
	public void testOfferCancel() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			byte[] messageData = VergeACCTv3.getInstance().buildCancelMessage(deployer.getAddress());
			...
			CrossChainTradeData tradeData = VergeACCTv3.getInstance().populateTradeData(repository, atData);
	...
	public void testTradingInfoProcessing() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			int refundTimeout = VergeACCTv3.calcRefundTimeout(partnersOfferMessageTransactionTimestamp, lockTimeA);

			// Send trade info to AT
			byte[] messageData = VergeACCTv3.buildTradeMessage(partner.getAddress(), vergePublicKeyHash, hashOfSecretA, lockTimeA, refundTimeout);
			...
			// Check trade partner's verge PKH was extracted correctly
			assertTrue(Arrays.equals(vergePublicKeyHash, tradeData.partnerForeignPKH));
	...
	public void testCorrectSecretCorrectSender() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			messageData = VergeACCTv3.buildRedeemMessage(secretA,  partner.getAddress());
	...
	public void testIncorrectSecretCorrectSender() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			messageData = VergeACCTv3.buildRedeemMessage(wrongSecret, partner.getAddress());
			messageTransaction = sendMessage(repository, partner, messageData, atAddress);
	...
	public void testDescribeDeployed() throws DataException {
		try (final Repository repository = RepositoryManager.getRepository()) {
			...
			for (ATData atData : executableAts) {
				...
				// Not one of ours?
				if (!Arrays.equals(codeHash, VergeACCTv3.CODE_BYTES_HASH))
					continue;
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = VergeACCTv3.buildQortalAT(tradeAddress, vergePublicKeyHash, redeemAmount, vergeAmount, tradeTimeout);
		...
		Long fee = null;
		String name = "QORT-XVG cross-chain trade";
		String description = String.format("Qortal-Verge cross-chain trade");
		String atType = "ACCT";
		String tags = "QORT-XVG ACCT";
